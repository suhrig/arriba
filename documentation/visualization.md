...
- file with fusion predictions by Arriba (`fusions.tsv`)
...
The following command demonstrates the usage. Please refer to section [Command-line options](command-line-options.md#draw-fusions-R) for a complete list of options.
