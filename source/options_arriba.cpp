...
void print_usage(const string& error_message) {
	...
	cerr << endl
	     << "Arriba RNA fusion detector" << endl
	     << "--------------------------" << endl
	     << "Version: " << ARRIBA_VERSION << endl << endl
	     << "Arriba is a fast tool to search for clinically relevant RNA fusions. " << endl
	     << "It is based on the chimeric BAM file generated by the STAR RNA-Seq aligner." << endl << endl
	     << "Usage: arriba -c chimeric.bam [-r read_through.bam] -x rna.bam -g annotation.gtf -o fusions.out " << endl
	     ...
	     << wrap_help("-a FILE", "FastA file with genome sequence (assembly). A FastA index "
	                  "with the extension .fai must be present. Arriba re-aligns reads to "
	                  ...
	                  "is provided, Arriba can indicate reference mismatches in the fusion "
	                  "transcript (see  -T).")
