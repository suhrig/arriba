...
void print_usage() {
	...
	cout << endl
	     ...
	     << "It is based on the chimeric BAM file generated by the STAR RNA-Seq aligner." << endl
	     << endl
	     ...
	     << wrap_help("-r FILE", "BAM file with read-through alignments as generated by "
	                  "'extract_reads'. STAR does not report read-through fusions "
	                  "in the chimeric.bam file. Such fusions must be extracted manually "
	                  "from the rna.bam file. This is accomplished with the help of"
	                  "the utility 'extract_reads'.")
