	...
	for (fusions_t::iterator fusion = fusions.begin(); fusion != fusions.end(); ++fusion) {
		...
		if (discordant_mates != discordant_mates_by_gene_pair.end()) {
			...
			for (auto discordant_mate = discordant_mates->second.begin(); discordant_mate != discordant_mates->second.end(); ++discordant_mate) {
				...
				if (((fusion->second.direction1 == DOWNSTREAM && mate1->strand == FORWARD && (mate1->end-2 <= fusion->second.breakpoint1 && fusion->second.split_reads1 + fusion->second.split_reads2 > 0 || mate1->end-max_mate_gap <= fusion->second.breakpoint1 && fusion->second.split_reads1 + fusion->second.split_reads2 == 0)) || (fusion->second.direction1 == UPSTREAM && mate1->strand == REVERSE && (mate1->start+2 >= fusion->second.breakpoint1 && fusion->second.split_reads1+fusion->second.split_reads2 > 0 || mate1->start+max_mate_gap >= fusion->second.breakpoint1 && fusion->second.split_reads1+fusion->second.split_reads2 == 0))) &&
				    ((fusion->second.direction2 == DOWNSTREAM && mate2->strand == FORWARD && (mate2->end-2 <= fusion->second.breakpoint2 && fusion->second.split_reads1 + fusion->second.split_reads2 > 0 || mate2->end-max_mate_gap <= fusion->second.breakpoint2 && fusion->second.split_reads1 + fusion->second.split_reads2 == 0)) || (fusion->second.direction2 == UPSTREAM && mate2->strand == REVERSE && (mate2->start+2 >= fusion->second.breakpoint2 && fusion->second.split_reads1+fusion->second.split_reads2 > 0 || mate2->start+max_mate_gap >= fusion->second.breakpoint2 && fusion->second.split_reads1+fusion->second.split_reads2 == 0)))) {
